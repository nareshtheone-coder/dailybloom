...
import { RACING_LETTERS_4_5 } from '../../data/gamesLibrary'
...
export default function LetterRace({ onBack }: LetterRaceProps) {
  ...
  const targetLetters = RACING_LETTERS_4_5
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-br from-red-300 via-yellow-300 to-orange-300 flex flex-col items-center justify-center p-4 overflow-hidden">
      {/* Header */}
      <div className="mb-6 text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">
          🏃 Letter Race
        </h1>
        <p className="text-white text-lg drop-shadow">Tap letters in order to race forward!</p>
      </div>
      ...
      {gameComplete && (
        <div className="text-center mb-8 animate-bounce">
          ...
          <p className="text-white text-xl mt-2 drop-shadow">Amazing race! 🎉</p>
        </div>
      )}
